...
import fr.arboretum.ui.adapter.SearchResultsAdapter;
import fr.arboretum.ui.components.ApplicationAutoCompleteAdapter;
...
public class MainActivity extends ListActivity {
	...
	public static final String SUBJECT_ID_ITENT_PRM = "bird_id_intent_prm";
	...
	private Intent buildIntentBirdInfoActivity(final Integer birdId) {
		...
		birdIntent.putExtra(SUBJECT_ID_ITENT_PRM, birdId);
		return birdIntent;
	}
	...
	void onTextChangesOnSearchField(CharSequence userInput) {
		...
		List<SimpleSubject> queryResult = ServiceFactory.getService(this)
				.getMatchingSubjects(userInput.toString());
